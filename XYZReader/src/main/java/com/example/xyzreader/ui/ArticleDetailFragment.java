...
public class ArticleDetailFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ctl = (CollapsingToolbarLayout) mRootView.findViewById(R.id.ctl);
                            ...
                            .intoCallBack(
                                    new GlidePalette.CallBack() {
                                        ...
                                        public void onPaletteLoaded(Palette palette) {
                                            if (isAdded()) {
                                                ctl.setContentScrimColor(palette.getVibrantColor(getResources().getColor(R.color.theme_primary)));
                                                ctl.setStatusBarScrimColor(palette.getVibrantColor(getResources().getColor(R.color.theme_primary_dark)));
                                                System.out.println(palette.getDarkVibrantSwatch());
                                            }
                                        }
                                    })
